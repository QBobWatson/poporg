...
real-time feedback while writing.  To silence these, I forked another
[[https://github.com/pinard/pep8][pep8 distribution]] from the original one, and containing only a very
tiny patch over the [[https://github.com/jcrocholl/pep8][official one]].
